...
namespace CRMDBService
{
    public class DbHelper
    {
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        public int ExecuteNonQuery(string sqlQuery, System.Data.SqlClient.SqlParameter[] mysqlParameter, CommandType ct)
        {
            int returnValue = 0;
            ...
            DbCommand dbCommand = connection.CreateCommand();
            dbCommand.CommandText = sqlQuery;
            dbCommand.Parameters.AddRange(mysqlParameter);
            dbCommand.CommandType = ct;
