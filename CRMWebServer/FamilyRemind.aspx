<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FamilyRemind.aspx.cs" Inherits="CRMWebServer.Process.FamilyRemind" %>
    ...
    <table width="98%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="left_txt">当前位置：家长提醒</td>
          </tr>
          <tr>
            <td height="20">
          ...
          <tr>
            ...
            <table width="100%" height="55" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="90%" valign="top"><span class="left_txt2">本页面负责家长生日提醒查看</span><span 
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr >
                ...
                <td bgcolor="#f2f2f2" class="style5">
                    <asp:GridView ID="gvFamilyRemind" runat="server" CellPadding="3" ForeColor="Black" 
                        GridLines="Horizontal" AutoGenerateColumns="False" 
                         Width="100%" DataKeyNames="FRemindID" 
                        onrowdatabound="gvFamilyRemind_RowDataBound" 
                        onselectedindexchanged="gvFamilyRemind_SelectedIndexChanged" 
                        onselectedindexchanging="gvFamilyRemind_SelectedIndexChanging" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ParentMobilephone" HeaderText="家长手机" >
                            <FooterStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
